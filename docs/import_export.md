...
SMASH currently supports importing data from the [Geopaparazzi Survey Server](https://www.geopaparazzi.org/gss/index.html) (GSS).

<!-- NEEDS SCREENSHOT: images/import_view.png -->
...
SMASH can export the project's data to a few common file formats, and can synchronize it with the [Geopaparazzi Survey Server](https://www.geopaparazzi.org/gss/index.html).

<!-- NEEDS SCREENSHOT: images/export_view.png -->
...
<!-- NEEDS SCREENSHOT: images/gss_export_stats.png -->
...
:::{note}
PDF export code exists in the project but is not currently wired into the Export screen, so it is not reachable from the app as of this writing. It is left out of this manual on purpose; if it gets re-enabled, this section should document it again.
:::
