...
class PdfExporter {
  ...
  static Future<void> exportDb(ProjectDb db, File outputFile) async {
...
//            }
              ...
              var p = pw.Paragraph(
                  text: '$value', style: pw.TextStyle(fontSize: size));
              formWidgetList.add(p);
            } else {
    ...
    pdf.addPage(pw.MultiPage(
        ...
        header: (pw.Context context) {
          ...
          return pw.Container(
              ...
              child: pw.Text('Report of project $dbName',
              ...
              pw.Header(
                  ...
                  child: pw.Row(
                      ...
                      children: <pw.Widget>[
                        ...
                        pw.FittedBox(
                          child: pw.Paragraph(
                              text: 'Project: ${dbName.replaceAll("_", " ")}',
