...
Opens the project view, where you can:

- browse the local folders to open an existing project
- create a new project, entering a name or accepting the default one based on the current timestamp
- pick one of the most recently used projects from a list.
...
See [Import](import_export.md#import).

## Export

See [Export](import_export.md#export).
...
Opens the online SMASH documentation in the browser (requires an internet connection).
